...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	//configuração para liberar o acesso ao Swagger na aplicação
	@Override
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST, PUBLIC_MATCHERS_POST).permitAll()//permite somente endpoints com POST e informados no vetor
