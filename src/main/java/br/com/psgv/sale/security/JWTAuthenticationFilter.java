...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	// injetando as duas variaveis no construtor
	...
	// este método já recebe o objeto auth informado acima se o token foi válido ou
	// não
	@Override
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		// Informa ao CORS(Cross-origin resource sharing) que o response do header
		// estará sendo customizado e será incluido no header o campo Authorization
