...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
        ...
        Categoria cat6 = new Categoria(null, "Itens para casa");
        Categoria cat7 = new Categoria(null, "Linha odonto");
        
        Produto p1 = new Produto(null, "Computador", 2000.00);
        Produto p2 = new Produto(null, "Impressora", 800.00);
        Produto p3 = new Produto(null, "Mouse", 80.00);
        Produto p4 = new Produto(null, "Mesa", 1000.00);
        Produto p5 = new Produto(null, "Tapete Colorido", 300.00);
        Produto p6 = new Produto(null, "Tapete", 500.00);
        Produto p7 = new Produto(null, "TV", 3000.00);
        Produto p8 = new Produto(null, "Chapéu", 80.00);
        Produto p9 = new Produto(null, "Abajur", 150.00);
        Produto p10 = new Produto(null, "Lustre", 2500.00);
        Produto p11 = new Produto(null, "Shampoo", 12.00);
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "lucas.t.banin@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, passwordEncoder.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("23589546", "956321592"));
        
        Cliente cli2 = new Cliente(null, "Lucas Tartarini", "tartarinibanin@gmail.com", "38941569885", TipoCliente.PESSOA_FISICA, passwordEncoder.encode("123"));
        ...
        Endereco e3 = new Endereco(null, "Avenida Floriano", "23", null, "Barcelona", "09518900", cli2, c1);
