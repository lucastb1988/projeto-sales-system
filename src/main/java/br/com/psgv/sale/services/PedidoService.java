...
public class PedidoService {
	...
	public Pedido insert(Pedido obj) {
		...
		// preencher data de vencimento 7 dias após instante do pedido caso pagamento
		// for boleto
	...
	// cliente só recupera seus pedidos, se for outro cliente não recupera os
	// pedidos de tal cliente e dá pau
